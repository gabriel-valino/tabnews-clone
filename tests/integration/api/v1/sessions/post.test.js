...
describe("POST /api/v1/session", () => {
  describe("Anonymous user", () => {
    ...
    test("With correct `password` and correct `email`", async () => {
      ...
      const actualLifetimeInMilliseconds = expiresAt - createdAt; // Aqui ele calcula quanto tempo a sessão realmente dura.

      const lifetimeDifferenceInMilliseconds =
        session.EXPIRATION_IN_MILLISECONDS - actualLifetimeInMilliseconds; // “Quanto tempo está faltando para chegar nos 30 dias ideais?”
